...
```txt
   ...
   3. 使用如下命令进行构建
      ...
      3.2 ./configure --prefix=/home/wei/OPEN_SOURCE/Firmware-Engineer/000.STM32/003.OpenOCD/OpenOCD-INSTALL-DIR/000.PREFIX --exec-prefix=/home/wei/OPEN_SOURCE/Firmware-Engineer/000.STM32/003.OpenOCD/OpenOCD-INSTALL-DIR/001.EPREFIX 
      3.3  make
