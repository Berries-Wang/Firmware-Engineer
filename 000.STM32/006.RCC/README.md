...
学习:[时钟树-上](./999.IMGS/001.时钟树-上/) & [时钟树-下](./999.IMGS/002.时钟树-下/) & [RCC与时钟树编程](./999.IMGS/000.RCC与时钟树编程/)
## 摘要
...
- STM32为了低功耗，他将所有的外设时钟都设置为disable(不使能)，用到什么外设，只要打开对应外设的时钟就可以， 其他的没用到的可以还是disable(不使能)，这样耗能就会减少。  

这就是为什么不管你配置什么功能都需要先打开对应的时钟的原因
