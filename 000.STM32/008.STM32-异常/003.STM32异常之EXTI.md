...
- ![wechat_2025-10-22_232327_018.png](./999.REF_DOCS/wechat_2025-10-22_232327_018.png)
   + 需要注意，同一时刻，只有一个输入有效： 对于EXTI0,如果配置了PA0作为中断源，那么其他(PB0,PC0...)都不能配置为EXTI0的中断源了
---

### 如何编程
在 [Figure 20. External interrupt/event controller block diagram](../../002.REF_DOCS/rm0008-stm32f101xx-stm32f102xx-stm32f103xx-stm32f105xx-and-stm32f107xx-advanced-armbased-32bit-mcus-stmicroelectronics.pdf) ![wechat_2025-11-01_181233_915.png](./999.REF_DOCS/wechat_2025-11-01_181233_915.png)

这就是EXTI电路图，通过库函数配置其中的寄存器，从而配置EXTI
